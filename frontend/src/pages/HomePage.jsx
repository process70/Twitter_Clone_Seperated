...
const HomePage = () => {
	...
	return (
		<>
			<div className='flex-[4_4_0] mr-auto border-r border-gray-700'>
				{/* Header */}
				<div className='flex  border-b border-gray-700'>
					...
					<div className='flex justify-center flex-1 p-3 hover:bg-secondary duration-1000 cursor-pointer relative'
